...
m12_subhalo_history = sio.loop_hal(m12_st, 'star.number', infall_hist, **{'time_file_path':time_tbl_path})

clean_m12_subhalo_history = get_unique_subhalos(m12_subhalo_history['m12b'])

ut.io.file_hdf5('m12b_subhalo_history_nstar6_50-500kpc', dict_or_array_to_write=clean_m12_subhalo_history)
