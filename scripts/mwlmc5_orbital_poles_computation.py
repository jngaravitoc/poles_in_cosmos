...
if __name__ == "__main__":
    ...
    nsat=15000000
    """
    pos_com_host, vel_com_host = load_halo(snapshot+snapname+"_000".format(k), N_halo_part=[nhost, nsat], q=['mass'],  com_frame=0, galaxy=0, snapformat=3, com_method='diskpot')
